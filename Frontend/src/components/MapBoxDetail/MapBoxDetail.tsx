...
export function MapBoxDetailAdmin({
  ...
  return (
    <>
      ...
      >
        <img
          src={'https://hips.hearstapps.com/hmg-prod/images/2024-b…crop=0.637xw:0.716xh;0.264xw,0.225xh&resize=768:*'}
          alt=""
        ...
        <div style={{ margin: '1rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <Typography style={{ fontWeight: 'bold' }}>รถชนต์แล้วรถติดมากเลยค่ะ หลีกเลี่ยงเส้นทาง</Typography>
